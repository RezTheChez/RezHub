...
local Client = {
    Github = "https://github.com/RezTheChez/RezHub/tree/main/scripts",
    Games = loadstring(game:HttpGet(("https://raw.githubusercontent.com/RezTheChez/RezHub/main/Games.lua")))(),
    SupportedExploits = {
        "Synapse X";
        "Script-Ware";
        "Krnl";
